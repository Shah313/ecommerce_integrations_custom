...
class TestCase(unittest.TestCase):
    config: ClassVar = {
        ...
        "warehouse_mapping": [
            ...
            {
                "unicommerce_facility_code": "B",
                "erpnext_warehouse": "Work In Progress - WP",
                "enabled": 1,
            },
        ],
    }
    ...
    def setUpClass(cls):
        ...
        for wh_map in settings.warehouse_mapping:
            ...
            cls.old_config["warehouse_mapping"].append(
                {k: wh_map.get(k) for k in keys_to_retain}
            )
...
def _setup_test_item_categories():
    frappe.get_doc(
        {
            "doctype": "Item Group",
            PRODUCT_CATEGORY_FIELD: "TESTCAT",
            "item_group_name": "Test category",
        }
