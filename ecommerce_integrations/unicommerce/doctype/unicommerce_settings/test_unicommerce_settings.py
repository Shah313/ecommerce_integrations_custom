...
class TestUnicommerceSettings(TestCase):
    ...
    def test_authentication(self):
        ...
        self.assertEqual(
            self.settings.access_token, "1211cf66-d9b3-498b-a8a4-04c76578b72e"
        )
        self.assertEqual(
            self.settings.refresh_token, "18f96b68-bdf4-4c5f-93f2-16e2c6e674c6"
        )
    ...
    def test_failed_auth(self):
        ...
        responses.add(
            responses.GET,
            "https://demostaging.unicommerce.com/oauth/token",
            json={},
            status=401,
        )
