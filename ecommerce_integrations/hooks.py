...
override_whitelisted_methods = {
    "ecommerce_integrations.shopify.webhooks.refund_created": "ecommerce_integrations.shopify.shopify_refund_dispatcher.shopify_refund_dispatcher"
}


override_whitelisted_methods = {
    "ecommerce_integrations.api.pipe17_api.test_pipe17_connection": "ecommerce_integrations.api.pipe17_api.test_pipe17_connection"
}

doctype_js = {"Pipe17 Settings": "public/js/pipe17/pipe17_settings.js"}

doc_events = {
    "Stock Entry": {
        "on_submit": "ecommerce_integrations.api.pipe17_api.on_stock_entry_submit"
    }
}

doctype_js = {"Stock Entry": "public/js/pipe17/stock_entry_mobix.js"}
