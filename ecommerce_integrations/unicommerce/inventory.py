...
def update_inventory_on_unicommerce(client=None, force=False):
    ...
    for warehouse in warehouses:
        ...
        inventory_map = {
            d.integration_item_code: cint(d.actual_qty) for d in erpnext_inventory
        }
        ...
        if status:
            ...
            sku_to_ecom_item_map = {
                d.integration_item_code: d.ecom_item for d in erpnext_inventory
            }
...
def _update_inventory_sync_status(
    ecom_item_success_map: dict[str, bool], timestamp: str
) -> None:
